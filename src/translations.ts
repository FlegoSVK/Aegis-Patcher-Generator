...
export const translations = {
  sk: {
    ...
    readmeUpdateTitle: '--- AKTUALIZÁCIA PREKLADU ---',
    readmeUpdateText: 'Ak inštalujete novšiu verziu prekladu, inštalátor automaticky prepíše staršiu verziu prekladu.\nNie je potrebné predchádzajúcu verziu prekladu odinštalovať.',
  ...
  cz: {
    ...
    readmeUpdateTitle: '--- AKTUALIZACE PŘEKLADU ---',
    readmeUpdateText: 'Pokud instalujete novější verzi překladu, instalátor automaticky přepíše starší verzi překladu.\nNení potřeba předchozí verzi překladu odinstalovat.',
